...
swagger_template = dict(
    info = {
        ...
        'version': '1.0.0',
        'description': 'Dokumentasi API untuk Analisa Sentimen - Rina Yulius & Ayu Ramadhani'
    },
    host = LazyString(lambda: request.host)
)
...
#file = open('resources_of_lstm/x_pad_sequences.pickle','rb') # pad_sequences
...
db = sqlite3.connect('C:/Users/user/yobisayo/database.db', check_same_thread = False)
...
model_file_from_rnn = load_model('model_of_rnn/model_rnn.h5')
model_file_from_lstm = load_model('model_of_lstm/model_lstm.h5')
...
def lstm_text():
    ...
    feature = tokenizer.texts_to_sequences(text)
    guess = pad_sequences(feature,maxlen=max_features)
